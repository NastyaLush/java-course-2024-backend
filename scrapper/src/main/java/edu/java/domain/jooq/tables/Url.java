...
public class Url extends TableImpl<UrlRecord> {
     ...
     */
    public final TableField<UrlRecord, Long> ID = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false)
                                                                                                .identity(true), this, "");
    /**
     ...
     */
    public final TableField<UrlRecord, OffsetDateTime> LAST_UPDATE = createField(DSL.name("LAST_UPDATE"), SQLDataType.TIMESTAMPWITHTIMEZONE(6)
                                                                                                                     .nullable(false), this, "");
    /**
     * The column <code>URL.LAST_CHECK</code>.
     */
    public final TableField<UrlRecord, OffsetDateTime> LAST_CHECK = createField(DSL.name("LAST_CHECK"), SQLDataType.TIMESTAMPWITHTIMEZONE(6)
                                                                                                                   .nullable(false)
                                                                                                                   .defaultValue(DSL.field("LOCALTIMESTAMP", SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
