...
public class ChatRecord extends UpdatableRecordImpl<ChatRecord> implements Record2<Integer, Integer> {
    ...
    @Override
    @NotNull
    public ChatRecord value1(@Nullable Integer value) {
        setId(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public ChatRecord values(@Nullable Integer value1, @NotNull Integer value2) {
        value1(value1);
        value2(value2);
        return this;
    }
    ...
    public ChatRecord(@Nullable Integer id, @NotNull Integer tgChatId) {
        super(Chat.CHAT);
