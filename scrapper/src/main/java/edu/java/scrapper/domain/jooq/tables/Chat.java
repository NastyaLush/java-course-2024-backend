...
public class Chat extends TableImpl<ChatRecord> {
     ...
     */
    public final TableField<ChatRecord, Integer> ID = createField(DSL.name("ID"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>CHAT.TG_CHAT_ID</code>.
     */
    public final TableField<ChatRecord, Integer> TG_CHAT_ID = createField(DSL.name("TG_CHAT_ID"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<UniqueKey<ChatRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.CONSTRAINT_1F8);
    }
